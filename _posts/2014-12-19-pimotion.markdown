...
description: "Explore motion detecting using two methods: manual calculations and H.264 motion vectors"
...
We will be using Python as the programming language. It is a nice clean language, a large collection of community developed libraries and great support.
